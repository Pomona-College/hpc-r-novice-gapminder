...
This workshop is part of the Pomona College HPC Workshop Series. Sensible next
steps:

- **Workshop 9 — SLURM Job Scheduling**: run your analysis unattended
- **Workshop 6 — Automation and Make**: rebuild only what changed
- **Workshop 12 — Data Transfer and Storage**: move data on and off Sagehen HPC
- **Workshop 21 — Reproducible Research Pipelines**: tie it all together
