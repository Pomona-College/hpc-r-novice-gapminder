...
Reproducible scientific analysis in R with dplyr, tidyr, ggplot2 and R Markdown. Adapted from Software Carpentry for Pomona College.

**Lesson site:** <https://pomona-college.github.io/hpc-r-novice-gapminder/>
...
Adapted from [swcarpentry/r-novice-gapminder](https://github.com/swcarpentry/r-novice-gapminder) by
...
The original lesson is maintained by Naupaka Zimmerman, Sehrish Kanwal and Matthieu Bruneaux, with contributions from many others. Please cite the original lesson as set out in `CITATION`.
...
[swcarpentry/r-novice-gapminder](https://github.com/swcarpentry/r-novice-gapminder) so the wider community
benefits.
